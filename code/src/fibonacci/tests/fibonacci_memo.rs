use crate::fibonacci::fibonacci_memo;
...
fn should_return_one() {
  ...
  // Act
  let result1 = fibonacci_memo(input1);
  let result2 = fibonacci_memo(input2);
  // Assert
...
fn should_correctly_compute_result() {
  ...
  let result1 = fibonacci_memo(input1);
  let result2 = fibonacci_memo(input2);
  let result3 = fibonacci_memo(input3);
  let result4 = fibonacci_memo(input4);
  // Assert
